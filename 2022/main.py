...
if color == None:
  if markingBlockColor == Color.WHITE: # water
    ...
    gurn(56, fb="backward", tp="pivot", speed=200) # 50, 54, 57
    grab(oc="open", percentage=1.25)
    straight(-90)
    grab(oc="close", percentage=1.25)
    straight(40)
...
straight(-45)
grab(oc="open")
liftasync(ud="down", percentage=0.5)
straight(70)
grab(oc="close")

# second
gurn(25, fb="forward", tp="pivot", speed=200)
liftasync(ud="up", percentage=0.5)
straight(-90)
grab(oc="open")
...
straight(50)
lift(ud="down", percentage=0.5)
gurn(18, fb="forward", tp="pivot", speed=200)
baystatus = frombay(baystatus, {"type" : "laundry", "color" : third[1]}, "front", liftheight=0.5, grabstatus="open")
straight(-65)
grab(oc="open")
